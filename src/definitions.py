...
KW_AGENT_MODULE = 'agent_module'
KW_AGENT_TYPE = 'agent_type'
KW_AGENT_IDS = 'agent_ids'

KW_NETWORK = 'network'
KW_NETWORK_C = 'network_c'
KW_NETWORK_K = 'network_k'
KW_NETWORK_PHI = 'network_phi'

KW_OBJECTIVE = 'objective'

KW_OPT_M = 'opt_m'						# number of classes
KW_OPT_N = 'opt_n'						# number of items in each class
KW_OPT_Q = 'opt_q'						# number of dimensions
